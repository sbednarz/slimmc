...
from .distributions import MolarMassDistribution, ChainLengthDistribution, DistributionGroup
...
class StorageChains:
    ...
    def cld(self, *, form: str = ..., mass_model: str | None = ...) -> ChainLengthDistribution: ...
    def mwd(self, *, form: str = ..., mass_model: str | None = ...) -> MolarMassDistribution: ...
    ...
    def cld_series(self, *, series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
    def mwd_series(self, *, series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
...
class StorageSnapshot:
    ...
    def mwd(self, *, pool: Any = ..., form: str = ..., mass_model: str | None = ...) -> MolarMassDistribution: ...
    def mwd_series(self, *, series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
    def cld(self, *, pool: Any = ..., form: str = ..., mass_model: str | None = ...) -> ChainLengthDistribution: ...
    def cld_series(self, *, series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
...
class StorageRun(Run):
    ...
    def mwd(self, *, snapshot: Any = ..., pool: Any = ..., form: str = ..., mass_model: str | None = ...) -> MolarMassDistribution: ...
    def mwd_series(self, *, snapshot: Any = ..., series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
    def cld(self, *, snapshot: Any = ..., pool: Any = ..., form: str = ..., mass_model: str | None = ...) -> ChainLengthDistribution: ...
    def cld_series(self, *, snapshot: Any = ..., series: Any, form: str = ..., normalization: str = ..., mass_model: str | None = ...) -> DistributionGroup: ...
