...
def check_h12_rate_actions(run):
...
def main():
    ...
    checks = {
        "H11_no_t0_save": check_h11_no_t0,
        "H11_same_time_coalesce": check_h11_coalesce,
        "H11_tend_action": check_h11_tend,
        "H12_rate_actions": check_h12_rate_actions,
        "H12_rate_switch_off": check_h12_switch_off,
        "H13_concentration_actions": check_h13,
        "H14_initial_and_independent": check_h14_initial,
        "H14_scheduled_cascade": check_h14_scheduled,
        "H14_stop_cadence": check_h14_stop,
    }
    ...
    run_failure(models / "H12_negative_rate_fail.model", engine, "add_k would make negative rate constant")
    print("[PASS] H12_negative_rate_fail")
    run_failure(models / "H13_negative_count_fail.model", engine, "add_c would make negative molecule count")
    print("[PASS] H13_negative_count_fail")
    print(f"[PASS] phase C integration ({len(checks) + 2} models)")
